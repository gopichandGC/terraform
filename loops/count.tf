resource "aws_instance" "web" {
  ...
  instance_type = var.instance_names[count.index]=="mongodb" || var.instance_names[count.index]=="mysql" || var.instance_names[count.index]=="shipping" ? "t3.small":"t2.micro" #var.instance_names=="Mongodb"?"t3.small":"t2.micro"
  tags={
